                ...
                <div class="card-header" id="heading_{{$i}}">
                    <h2 class="mb-0 d-inline">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                            ...
                            <table id="accounts" class="table table-bordered table-hover table-sm table-fixed" style=" table-layout: fixed ; width: 100% ";>
                                <thead>
                                <tr>
...
{{--
                                <tr>
                                    <tdstyle="width:33%" class="text-xl-left"><b>{{$disp_month}} {{$disp_year}}</b></td>
                                    <td style="width: 33% ;"
...
--}}
                                <tr>
                                    <td  style="width:33%" class="text-xl-left"> <b>{{$disp_month}} {{$disp_year}}</b></td>
