...
--}}
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="bonus_init">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                                        data-target="#collapseBonusInit" aria-expanded="false"
                                                        aria-controls="collapseBonusInit">
                                                    <h6 class="text-center">Set Monthly Bonus </h6>
                                                </button>
                                            </h2>
                                        </div>

                                        <div id="collapseBonusInit" class="collapse" aria-labelledby="bonus_init"
                                             data-parent="#accordionExample">
                                            <div class="card-body">
                                                <form method="post"
                                        ...
                                        <div class="card-header" id="headingSixPlus">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link collapsed" type="button"
                                                    ...
                                                    <h6>View Margin Commissions up to May 2020</h6>
                                                </button>
                                            </h2>
                                        </div>
