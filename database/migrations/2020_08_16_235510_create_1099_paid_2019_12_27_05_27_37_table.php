...
class Create1099Paid20191227052737Table extends Migration {
	...
	public function up()
	{
		Schema::create('1099_paid_2019_12_27_05_27_37', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('1099_paid_2019_12_27_05_27_37');
	}
