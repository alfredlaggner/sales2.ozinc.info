...
class Create1099Paid207Pp1022756Table extends Migration {
	...
	public function up()
	{
		Schema::create('1099_paid_20_7_pp1_022756', function(Blueprint $table)
		{
	...
	{
		Schema::drop('1099_paid_20_7_pp1_022756');
	}
