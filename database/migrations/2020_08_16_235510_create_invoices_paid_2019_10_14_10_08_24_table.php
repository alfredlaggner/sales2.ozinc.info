...
class CreateInvoicesPaid20191014100824Table extends Migration {
	...
	public function up()
	{
		Schema::create('invoices_paid_2019_10_14_10_08_24', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('invoices_paid_2019_10_14_10_08_24');
	}
