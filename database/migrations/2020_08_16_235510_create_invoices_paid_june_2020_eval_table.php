...
class CreateInvoicesPaidJune2020EvalTable extends Migration {
	...
	public function up()
	{
		Schema::create('invoices_paid_june_2020_eval', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('invoices_paid_june_2020_eval');
	}
