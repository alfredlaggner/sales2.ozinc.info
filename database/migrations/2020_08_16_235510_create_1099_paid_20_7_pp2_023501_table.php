...
class Create1099Paid207Pp2023501Table extends Migration {
	...
	public function up()
	{
		Schema::create('1099_paid_20_7_pp2_023501', function(Blueprint $table)
		{
	...
	{
		Schema::drop('1099_paid_20_7_pp2_023501');
	}
