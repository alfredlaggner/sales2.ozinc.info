...
class Create1099Paid206Pp1023411Table extends Migration {
	...
	public function up()
	{
		Schema::create('1099_paid_20_6_pp1_023411', function(Blueprint $table)
		{
	...
	{
		Schema::drop('1099_paid_20_6_pp1_023411');
	}
