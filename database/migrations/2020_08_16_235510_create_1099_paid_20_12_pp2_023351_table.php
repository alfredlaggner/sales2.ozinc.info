...
class Create1099Paid2012Pp2023351Table extends Migration {
	...
	public function up()
	{
		Schema::create('1099_paid_20_12_pp2_023351', function(Blueprint $table)
		{
	...
	{
		Schema::drop('1099_paid_20_12_pp2_023351');
	}
