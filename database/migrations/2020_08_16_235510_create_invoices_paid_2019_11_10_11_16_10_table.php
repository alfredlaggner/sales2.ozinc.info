...
class CreateInvoicesPaid20191110111610Table extends Migration {
	...
	public function up()
	{
		Schema::create('invoices_paid_2019_11_10_11_16_10', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('invoices_paid_2019_11_10_11_16_10');
	}
