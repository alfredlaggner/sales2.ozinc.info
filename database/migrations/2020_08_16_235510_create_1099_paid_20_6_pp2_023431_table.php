...
class Create1099Paid206Pp2023431Table extends Migration {
	...
	public function up()
	{
		Schema::create('1099_paid_20_6_pp2_023431', function(Blueprint $table)
		{
	...
	{
		Schema::drop('1099_paid_20_6_pp2_023431');
	}
